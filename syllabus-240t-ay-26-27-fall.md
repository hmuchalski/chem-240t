...
| Office hours | Tue/Thu  1-3 pm or by [appointment][gcal-apptmt] |

[gcal-apptmt]: https://calendar.app.google/fCWM2LJCNbThzuXw8
...
- **Canvas:** The central repository for all course materials and information is our Canvas site, accessible through [UPDATE](). The Canvas site will house assignments, grades, and links to materials/resources.
...
- classify organic transformations as addition, substitution, elimination, metathesis, or rearrangement
...
1. Design synthesis of organic compounds using retrosynthetic analysis framework
2. Weigh the issues of chemo-, regio-, and stereoselectivity in synthetic design by recognizing steric, electronic, and stereoelectronic effects that influence the outcome of chemical reactions. 
3. Communicate the structure and reactivity of organic molecules using drawing and naming notation and using effective oral communication.
4. Navigate the landscape of total synthesis of complex natural products, evaluate synthetic plans, and making connections between reactions and their mechanisms. 
5. Demonstrate organic synthesis skills through planning, execution, and troubleshooting of multi-step synthetic sequences. 
6. Identify flaws in synthetic plans by recognizing selectivity or efficiency issues. 
7. Read and follow research articles on total syntheses of natural products and identify strategies and tactics that allow chemists to construct complex molecules.

### Student-centered objectives

The list above is very general and each objective has broad scope (course-level). We will break these down into more specific objectives that we will focus throughout the semester. But content is only one dimension of the studies you will undertake. In addition to the list above you will:

- Develop a deep understanding of the big ideas in organic synthesis (efficiency, selectivity, retrosynthesis).
- Learn to communicate technical knowledge in a manner expected of a graduate student in chemical sciences. Particularly important are your homework, portfolio, class journal articles, and presentations. These are expected to be written to a professional standard. 
- Learn chemistry from a new point of view and gain historical perspective of developments in organic synthesis, and understanding the importance of this field in biology, material science, and medicine.

The goal of this course is to provide opportunities for development of a skill which you need as a person seeking an advanced degree: to quickly learn complex and unfamiliar topics to the degree that you can teach them to others. Active participation in class discussions is the key element of getting the most out of this class. Expect to be at the board frequently to discuss your worl and the work of your peers. You will feel weak in many areas. The goal is to identify those areas to strengthen your understanding and refine thinking process. This means that it is of highest importance that you come to class prepared.

## Course workflow

Course workflow is based on a weekly cadence of Problem Sets. First, you will study the problems and try to solve them on your own before class (Class Prep). During class, you will present your solutions and discuss them with classmates. After class, you will write up selected problems as a formal homework assignment. You may revise and resubmit some of your homework assignments. You may also submit some of your work to the Class Journal. All of your work will be collected and curated in your Portfolio, which will be the main evidence for your final grade.

> [!NOTE]
> Our class meetings are in the late afternoon when energy levels can be low and attention depleted. Lectures will be reduced to minimum and the course will be ran according to the flipped learning model, an instructional philosophy optimized for active learning. Direct instruction is done before class meetings through structured activities (reading assignments, videos, class prep, etc.). Class time is repurposed for collaborative work and practice. This [video series](https://vimeo.com/showcase/8484250) highlights the basics of flipped learning.
...
Here is how due dates work in the workplace: They exist, and they’re important. Often, however, there’s some flexibility with deadlines and if you need a little longer on something, you communicate with whoever set the deadline and negotiate new terms. This is usually not a big deal, but if it happens a lot, it raises questions and concerns

That is also how due dates work in this class. Talk to me if you need an extension and it helps if you propose a specific new deadline rather than asking for an extension that is undefined. Note that you may not get timely feedback if the extension is granted and your work is submitted later. 
...
Most of this class will center around organic synthesis problems. You will first encounter a problem in *Class Prep*. Before class, you will spend time attempting to solve this problem. You and classmates will help us come to a common understanding of these questions through your *in-class presentations* of Class Prep work and discussion of the solution. You will write up final solutions in *homework*, and may be allowed to revise them. The solutions to problems will eventually become elements of your *Portfolio* that showcases your progress. When you are especially proud of your work, you can submit it to the *Class Journal* too.Expect to spend a lot of time on each problem!
...
- **Earn 'exemplary' mark on several solutions throughout the semester and have several solutions accepted to the class journal.**
...
- Show that the scope of your studies are broader than the specific topics discussed in class. Share what you learned from reading the primary literature that goes beyond the class assigned reading. 
- When presenting, give answers to questions that show your deep understanding of the topic. When in audience, give feedback and ask questions.
...
- Keep a research notebook that contains all 'work-in-progress', shows how your ideas are collected, developed, and organized. 
...
Frequently meet many of the criteria (and **all but one of the boldface criteria**) listed above (missing at most 3 items) and *show meaningful progress on many of the criteria you don't fully meet*. 
...
Either meet *a few of the criteria consistently* (5--6 total), **and at least 2 boldface items** OR *meet many (10--12) criteria but less often*. Show meaningful progress on a few more.
...
A new set of problems, focusing on specific topics, will be posted on Canvas or distributed in Class. Your goal is to attempt to solve all problems before the class or make as much progress as possible. This will ensure that you are ready to take an active part in our class presentations and discussions. The research notebook is a place to keep and organize your notes on reading material, research, and drafts of problems. 

In short, I’m asking you to attempt big, real, difficult problems before class. **This will not be easy!** But, it will be close to what a synthetic organic chemists are asked to do. You will learn what to do when you don’t know what to do; how to find and try multiple approaches; the benefits of collaborating in order to generate new ideas and understand old ones; and how reflecting on past mistakes and errors can feed your growth.

Think of Class Prep as a demonstration that you put significant time and effort into studying the topic, and that you are committed to understanding and solving the required problems. *Correctness is not a factor---it’s OK if this work contains errors.* The goal is to be prepared. Class Prep work should take most of the time allocated to this course. Start as soon as the problems are posted.

**Research notebook**. You will need a way to keep handwritten notes organized. I suggest a bound notebook or a 3-ring binder that is dedicated to this class. Keep all of your Class Prep work together, dated and ordered, so that information is easy to find. You will often refer to your past work, so it’s important to keep it organized. I may occasionally ask to see your research notebook, to ensure it is complete and organized.

### How to work on Class Prep problems

Review the suggested reading and problems posted on Canvas. Read the text carefully, for full understanding. If there are new reactions or mechanisms, create examples to help you understand them. For each problem:

- Copy the problem statement and label it. Don't hesitate to start problem on a new page as it helps find it later and leaves space for adding comments as we discuss the problem in class. 
...
- Include commentary that will help me (and your future self) understand these unstructured notes and follow along. 
...
The central part of this class is sharing your thinking process with classmates. You can do this by presenting solutions in class and submitting articles to the class journal. Presentations and class journals are great ways to show your engagement with chemistry ideas and with your peers. 

### Presentations in class

When you submit your Class Prep assignment, indicate which problems you are volunteering to present and be ready to present your solution when called. I will select presenters based on who has volunteered, and who has presented the least recently. I may ask multiple students to present the same problem, if their solutions are different or illustrate interesting issues. It's likely that **you will not present every time you volunteer** but you ought to put your name forward to show that you are ready to do it when called. 
...
I will select problems from the weekly set and assign as a formal write-up. Your task will be to compose a correct, complete, convincing, and clear solutions to the problems. This should be based on your own Class Prep work, presentations, and class discussions. Your work should meet the objectives listed in the assignment. There may be additional specifications depending on the week's focus. Homeworks must be prepared as ChemDraw documents (templates will be available on Canvas).
...
You may only have one problem claimed at a time. Just like with presentations, if more than one person requests the same problem at the same time, I will choose based on who has completed fewer journals. You may be asked to select another problem if it's no longer available.
...
**Who can I collaborate with?** In CHEM 240T, collaboration is permitted and even encouraged in most circumstances. In particular, you should treat your peers as a resource for understanding synthetic organic chemistry. You may only collaborate with students currently enrolled in CHEM 240T and you must **acknowledge the input of others.** In all work, clearly state the name(s) of the person(s) you collaborated with on each problem, especially if they are the main source that allowed you to solve the problem. If you follow the instructions in this document, this will not harm your grade.
...
- You are permitted to collaborate on big ideas and general strategies but you must always write solutions independently. All collaboration on homework exercises should occur when your collaborators are at essentially the same stage of the problem solution as yourself. For example, if you have not yet started problem #4 and you ask a friend (who has already completed it), "How did you do problem 4?", this counts as academic misconduct. The resulting work is not and cannot be considered your own.
- On every homework problem, every step of every solution must be one that you understand yourself and that you have generated by thinking about the problem. 
